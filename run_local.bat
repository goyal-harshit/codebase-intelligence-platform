@echo off
setlocal
title Codebase Intelligence - Local Dev
cd /d "%~dp0"
...
if exist "%ROOT%\.venv\Scripts\python.exe" (
  ...
  set "PYTHON=python"
  echo [INFO] No .venv found. Creating one and installing backend dependencies...
...
echo.
echo ============================================================
echo   Codebase Intelligence - Local Dev
...
echo   For a full production-like deploy (everything in Docker), use run_ui.bat instead.
echo ============================================================
echo.

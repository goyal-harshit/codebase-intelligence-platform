...
class GraphBuilder:
    ...
    def build(self, entities: list[CodeEntity], relationships: list[CodeRelationship]) -> dict:
        """Full ingest: entities, synthesized File nodes, then relationships."""
    ...
    def ingest_relationships(self, relationships: Iterable[CodeRelationship]) -> int:
        """Create edges, skipping any whose endpoints aren't known vertices
        (e.g. unresolved/external calls)."""
